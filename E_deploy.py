...
class Inference:
    ...
    def __init__(self, checkpoint_path, custom_env_config, num_eps = 1):
        self.checkpoint_path   = checkpoint_path
        self.custom_env_config = custom_env_config
        self.num_episodes_during_inference = num_eps
    ...
    def play_env(self):
        ...
        while num_episodes < self.num_episodes_during_inference:
            ...
            action = algo.compute_single_action(observation=obs, explore=False, policy_id="default_policy")
